...
//Cambiar opacidad con scroll en el topBar
...
//Añadimos un paddingTop basado en la altura al main-content o el contenido prinicipal
...
const containerSopotifyPlaylists = document.querySelectorAll('.card-spotify-playlists');
...
containerSopotifyPlaylists.forEach(card => {
    createButton(card);
})
